...
This project shows simple, safe endpoints you can call from Shortcuts; add a voice phrase in Shortcuts to trigger them via Siri.

Contents
- app/ - the Flask app
- examples/shortcuts/ - instructions for creating Shortcuts that call this API
- examples/web/ - small web UI to test calls from a browser (keep your API key secret)
- examples/powershell/ - helper PowerShell scripts for Windows
